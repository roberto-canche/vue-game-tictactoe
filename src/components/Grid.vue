...
<script>
    ...
    export default {
        ...
        methods: {
            // changes the active player to the non-active player with the help of the nonActivePlayer conputed property
            changePlayer () {
                this.activePlayer = this.nonActivePlayer
            },

            //Cheacks for possible win conditions from de data
            checkForWin () {
                for (let i = 0; i < this.winConditions.length; i++) {
                    ...
                    // Compares 3 cell values based on the cells in condition
            ...
            gameIsWon () {
                ...
                // Fires an event for the Cell fo freeze
                Event.$emit('freeze')
            ...
            areEqual () {
                ...
                // Loops through each value and compares then with an empty sting and
                // for inequality
                for ( var i = 1; i < len; i++) {
